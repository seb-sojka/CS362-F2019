...
int main()
{
	...
	assert(0, returnValue, "Return value should be -1");
	assert(4cd , G.handCount[player], "Player's handCount should be four.");
	...
	assert(6, getCost(silver), "Cost of gold card to gain should be six");
